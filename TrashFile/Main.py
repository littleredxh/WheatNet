...
class learn():
    ...
    def run(self):
        ...
        self.setModel()
        self.printInfo()
        num_epochs=self.lr_decay_epoch*3
    ...
    def loadData(self):
        data_transforms = {'train': transforms.Compose([
                                    transforms.Resize(size=224*4, interpolation=Image.BICUBIC),
            ...
            for phase in PHASE:
                ...
                if phase == 'train':
                    ...
                    if self.mp:
                        ...
                        if epoch < int(num_epochs*0.3): self.model.module.R.d_rate(0)
                    ...
                    if not self.mp:
                        ...
                        if epoch < int(num_epochs*0.3): self.model.R.d_rate(0.15)
